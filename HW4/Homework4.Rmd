...
```{r}
predict_test <- summary(y_pred)
predict_test
```

```{r}
sprintf("This model predicts that %d insurance customers would have an auto accident, while %d will not.", predict_test[[2]], predict_test[[1]])
```